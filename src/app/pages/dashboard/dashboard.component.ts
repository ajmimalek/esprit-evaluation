...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    let gradientStroke: any = this.ctx.createLinearGradient(0, 230, 0, 50);

    gradientStroke.addColorStop(1, 'rgba(233,32,16,0.2)');
    gradientStroke.addColorStop(0.4, 'rgba(233,32,16,0.0)');
    gradientStroke.addColorStop(0, 'rgba(233,32,16,0)'); // red color
    ...
    const gradientStrokeGreen = this.ctx.createLinearGradient(0, 230, 0, 50);
    ...
    const gradientStrokeRed = this.ctx.createLinearGradient(0, 230, 0, 50);
